                    ...
                    .then(res =>{
                      ...
                      let test = res.data.map( uni =>{
                        ...
                        let arr = [];
                            ...
                            arr.push(uni.status)
                            let btn = null;
                            if(uni.status === "APPROVED_BY_DEAN")
...
console.log("aya")
   ...
   "timestamp": date.toISOString()
      ...
      axios.post('http://localhost:3001/api/HecApprove',obj, {withCredentials:true})
            .then(res => {
        ...
        <Card>
          ...
          <CardBody>
            <Table
              ...
              tableHead={["DegreeId", "Description", "Issuer", "Student", "Date", "University", "Status", "Approve" ]}
