    ...
    */
    ...
    async function Request_IBCC(tx) {
        ...
        const result = await request.get({ uri: 'http://172.20.50.158:2001/'+tx.cnic, json: true });
    ...
    async function Request_Nadra(tx) {
        ...
        const result = await request.get({ uri: 'http://172.20.50.158:2000/'+tx.cnic, json: true });
