...
describe('ApproveComponent', () => {
  ...
  let mockApproveService;
  let mockDataService

  beforeEach(async(() => {

    mockApproveService = sinon.createStubInstance(ApproveService);
    mockApproveService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ApproveService, useValue: mockApproveService },
